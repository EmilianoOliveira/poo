...
public class MainExercicio{
	...
	public static void main(String [] args){
		...
		int menu = Integer.parseInt(JOptionPane.showInputDialog("Opção (1) Adicionar, (2) Remover, (3) Consultar, (4) Sair: "));
		do{
			switch(menu){
				case 1:
			...
			menu = Integer.parseInt(JOptionPane.showInputDialog("Opção (1) Adicionar, (2) Remover, (3) Consultar, (4) Sair: "));
		}while(menu<4);
	}
}